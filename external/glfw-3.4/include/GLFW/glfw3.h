 ...
 * A library for BlackHoleSimulation-OpenGL, window and input
 *------------------------------------------------------------------------
 ...
 *  @brief Functions and types related to BlackHoleSimulation-OpenGL and BlackHoleSimulation-OpenGL ES contexts.
 *
 *  This is the reference documentation for BlackHoleSimulation-OpenGL and BlackHoleSimulation-OpenGL ES context related
 ...
 * the macOS BlackHoleSimulation-OpenGL header blocks the definition of ptrdiff_t by glext.h.
...
/* It is customary to use APIENTRY for BlackHoleSimulation-OpenGL function pointer declarations on
 * all platforms.  Additionally, the Windows BlackHoleSimulation-OpenGL header needs APIENTRY.
 */
#if !defined(APIENTRY)
 #if defined(_WIN32)
...
/* Some Windows BlackHoleSimulation-OpenGL headers need this.
 */
...
/* Include the chosen BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES headers.
 */
...
#endif /* BlackHoleSimulation-OpenGL and BlackHoleSimulation-OpenGL ES headers */
 ...
 *  current BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES context but no context is current on the calling
 ...
 *  requesting a non-existent BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES version like 2.7.
 *
 *  Requesting a valid but unavailable BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES version will instead
 ...
 *
 *  @par
 *  Some pre-installed Windows graphics drivers do not support BlackHoleSimulation-OpenGL.  AMD only
 *  supports BlackHoleSimulation-OpenGL ES via EGL, while Nvidia and Intel only support it via
 *  a WGL or GLX extension.  macOS does not provide BlackHoleSimulation-OpenGL ES at all.  The Mesa
 *  EGL, BlackHoleSimulation-OpenGL and BlackHoleSimulation-OpenGL ES libraries do not interface with the Nvidia binary
 *  driver.  Older graphics drivers do not support Vulkan.
 */
#define GLFW_API_UNAVAILABLE        0x00010006
/*! @brief The requested BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES version is not available.
 *
 *  The requested BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES version (including any requested context
 ...
 *
 *  @par
 *  Future invalid BlackHoleSimulation-OpenGL and BlackHoleSimulation-OpenGL ES versions, for example BlackHoleSimulation-OpenGL 4.8 if 5.0
...
/*! @brief The specified window does not have an BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES context.
 *
 *  A window that does not have an BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES context was passed to
...
/*! @brief BlackHoleSimulation-OpenGL stereoscopic rendering hint.
 *
 *  BlackHoleSimulation-OpenGL stereoscopic rendering [hint](@ref GLFW_STEREO).
 */
...
/*! @brief BlackHoleSimulation-OpenGL forward-compatibility hint and attribute.
 *
 *  BlackHoleSimulation-OpenGL forward-compatibility [hint](@ref GLFW_OPENGL_FORWARD_COMPAT_hint)
...
/*! @brief BlackHoleSimulation-OpenGL profile hint and attribute.
 *
 *  BlackHoleSimulation-OpenGL profile [hint](@ref GLFW_OPENGL_PROFILE_hint) and
 ...
 *  compile-time options.  It should not be confused with the BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES version
 ...
 *
 *  For gamma correct rendering with BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES, see the @ref
 ...
 *
 *  This function creates a window and its associated BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES
 ...
 *  BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES context.
 *
 ...
 *  BlackHoleSimulation-OpenGL implementation is the only one available.
 *
 ...
 *  any other thread.
 *
 *  @remark @macos The OS only supports core profile contexts for BlackHoleSimulation-OpenGL
 *  versions 3.2 and later.  Before creating an BlackHoleSimulation-OpenGL context of version 3.2 or
 *  later you must set the [GLFW_OPENGL_PROFILE](@ref GLFW_OPENGL_PROFILE_hint)
 *  hint accordingly.  BlackHoleSimulation-OpenGL 3.0 and 3.1 contexts are not supported at all
 *  on macOS.
 *
 ...
 *  GLFW_PLATFORM_ERROR.
 *
 *  @remark The BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES context will not be destroyed or otherwise
 ...
 *  its BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES context.
 *
 *  @param[in] window The window to query.
 ...
 *  thread.
 *
 *  This function makes the BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES context of the specified window
 ...
 *  hint.
 *
 *  The specified window must have an BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES context.  Specifying
 ...
 *
 *  This function returns the window whose BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES context is
 ...
 *  rendering with BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES.  If the swap interval is greater than
 ...
 *
 *  This function sets the swap interval for the current BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES
 ...
 *  [API extension](@ref context_glext) is supported by the current BlackHoleSimulation-OpenGL or
 *  BlackHoleSimulation-OpenGL ES context.  It searches both for client API extension and context
 ...
 *  context.
 *
 *  This function returns the address of the specified BlackHoleSimulation-OpenGL or BlackHoleSimulation-OpenGL ES
...
/* Some BlackHoleSimulation-OpenGL related headers need GLAPIENTRY, but it is unconditionally
